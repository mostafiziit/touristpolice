    ...
    <div class="container w-100 m-5 card" style="border-radius:10px">
    	<div class="row">
    		<div class="col-8" style="border-radius:10px">
				...
				<img class="w-100" src="<?php echo base_url().$path ?>" style="border-radius:10px;margin-left:-15px">
    			
    			<?php echo form_open_multipart(''); ?>

    			<input type="file" name="pic" value="<?php echo base_url().$path ?>"  class="btn btn-info w-100" style="margin-left:-12px;border-radius:10px">
    		</div>
    		<div class="col-4">
    			<form action="" method="POST" class="m-3">
    				<input type="text" name="path" hidden="true" value="<?php echo base_url().$path ?>">
    				<div>
    					<label style="display:block;color:green">Place Name*</label>
    					<input type="text" required="text" value="<?php echo $name ?>" name="placename" class="w-100" style="border:1px solid blue;border-radius:6px;height:37px;margin-top:-4px;padding-left:6px">
    				</div>
    				<div class="mt-3">
    					<label style="display:block;color:green">Description*</label>
    					<textarea  required="text"  type="text" name="description" class="w-100" style="border:1px solid blue;border-radius:8px;height:120px;margin-top:-4px;vertical-align:top;padding-left:6px;"><?php echo $description ?></textarea>
    				</div>
    				<div class="mt-4">
    					<label style="display:block;color:green">Location*</label>
    					<select required="text" value="<?php echo $location ?>" name="location" class="w-100" style="border:1px solid blue;border-radius:8px;height:37px;margin-top:-4px">
