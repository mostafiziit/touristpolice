                    ...
                    <div class="row">
                        <div class="col-xl-2 col-lg-3">
                            <div class="single-widget-home mb-5 mb-lg-0">
                                <h3 class="mb-4">Others Links</h3>
                                <ul>
                                    <li class="mb-2"><a href="#">Transports </a></li>
                                    <li class="mb-2"><a href="#">Security Services</a></li>
                                    <li class="mb-2"><a href="#">Parjatan Corporation</a></li>
                        ...
                        <div class="col-xl-5 offset-xl-1 col-lg-6">
                            <div class="single-widget-home mb-5 mb-lg-0">
                                ...
                                <p class="mb-4">You can trust us. we only send Tourist Safety News, not a single.</p>  
                                <form action="#">
                ...
                <div class="container">
                    <div class="row">
                        <div class="col-lg-8 col-md-6">
                            <span>
Copyright &copy;<script>document.write(new Date().getFullYear());</script> All rights reserved | Md. Mostafizur Rahman  
